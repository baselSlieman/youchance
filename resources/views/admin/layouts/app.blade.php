                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('chats.index')}}" class="dropdown-item text-primary border-bottom"><i class="fab fa-telegram-plane me-2"></i>Chats</a>
                            <a href="{{route('charges.index')}}" class="dropdown-item text-primary border-bottom"><i class="fas fa-download me-2"></i>Chrges</a>
                            <a href="{{route('withdraws.index')}}" class="dropdown-item text-primary border-bottom"><i class="fas fa-upload me-2"></i>Withdraws</a>
                            <a href="{{route('ichancies.index')}}" class="dropdown-item text-primary border-bottom"><i class="fas fa-rocket me-2"></i>Ichancy</a>
                        </div>
                    </div>
                    <a href="{{route('categories.index')}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Categories</a>
                    <a href="{{route('products.index')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Products</a>
...
<div class="content">
    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
        <a href="index.html" class="navbar-brand d-flex d-lg-none me-4">
            <h2 class="text-primary mb-0"><i class="fas fa-robot"></i></h2>
        </a>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">YOUCHANCE</a>, All Right Reserved.
                        </div>
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed By <a href="https://YOUCHANCE.com">YOUCHANCE</a>
                        </div>
                    </div>
                </div>
            </div>
