        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-md-9 order-2 order-md-1">
                <div class="bg-light rounded p-3">
                    <div class="row">
                        <h5 class="col-md-6"><i class="fab fa-telegram text-primary"></i> @lang('Telegram Chats')</h5>
            ...
            <div class="col-12 col-md-2 order-4 order-md-4">
                <div class="bg-light rounded p-2">
                    <h5><i class="fa fa-chart-bar text-primary"></i> @lang('Diff'):</h5>
                    <div class="">
    ...
    <div class="container-fluid pt-4 px-4">
            <div class="row g-4">
                <div class="col-12 order-6 order-md-6">
                    <div class="bg-light rounded p-3">
                        <div class="row">
                            <h5 class="col-md-12"><i class="fas fa-rocket text-primary"></i> @lang('iChancy')</h5>
                        </div>
                        <div class="row g-2 mt-2">
                            <div class="col-4"><i class="fas fa-bolt"></i> @lang('Today'): {{ $ichancy_today_count }}</div>
                            <div class="col-4 text-center"><i class="fas fa-bolt"></i> @lang('Month'): {{ $ichancy_month_count }}</div>
                            <div class="col-4 text-end"><i class="fas fa-bolt"></i> @lang('Total'): {{ $ichancy_count }}</div>
                        </div>
                    </div>
                </div>
            </div>
