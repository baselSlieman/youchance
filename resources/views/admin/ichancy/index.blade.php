        ...
        <div class="row justify-content-center g-2 gx-3">
            ...
            <div class="col col-md-12 px-3">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h3><i class="fas fa-rocket"></i> @yield('title'):</h3>
                    ...
                    <tbody>
                        @forelse($ichancies as $ichancy)
                            <tr>
                                <td>{{ $ichancy->id }}</td>
                                <td>
                                    <p class="mt-1"><i class="far fa-user"></i> username: {{ $ichancy->chat->username}}</p>
                                    <p class="mt-1"><i class="fas fa-user"></i> chat id: {{ $ichancy->chat_id }}</p>
                                    <p class="d-none d-md-block"><i class="far fa-calendar-alt"></i> {{ $ichancy->created_at }}</p>
                                </td>
                                ...
                                <td class="d-none d-md-table-cell">
                                    ...
                                    <p><i class="fas fa-user-secret"></i> {{$ichancy->username}}</p>
                                    <p><i class="fas fa-lock"></i> {{$ichancy->password}}</p>
                                    <p>
                            ...
                            <tr class="d-table-row d-md-none">
                                <td colspan="2">
                                    ...
                                    <i class="fas fa-user-secret me-2"></i><span class="fw-bold text-success">user:</span> {{$ichancy->username}}<br>
                                    <i class="fas fa-lock me-2"></i><span class="fw-bold text-success">pass:</span> {{$ichancy->password}}<br>
                                    <i class="fas fa-info-circle me-2"></i> <span class="fw-bold">status:</span> {{$ichancy->password}}
                                </td>
                            </tr>
                            <tr class="d-table-row d-md-none">
                            ...
                            <!-- Modal -->
<div class="modal fade" id="messageModal{{$ichancy->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form method="post" action="{{ route('ichancies.store', $ichancy) }}">
