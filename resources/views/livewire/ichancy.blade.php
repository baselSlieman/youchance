<div class="col col-md-12 px-3">
    ...
    <div class="row align-items-center">
        <h3 class="col-6 col-md-5 mb-0"><i class="fas fa-rocket text-primary"></i> iChancy:</h3>
        ...
        <div class="col-12 col-md-3 mt-2 mt-md-0"><input wire:model.live.debounce.500ms="search" type="search" class="form-control" placeholder="Search..."/></div>
    </div>
        ...
        <tbody>
            @forelse($ichancies as $ichancy)
                <tr>
                    ...
                    <td>
                        <p class="mb-2"><i class="fas fa-chess-king"></i> Player Id: <strong class="text-dark">{{$ichancy->identifier}}</strong></p>
                        <p class="mb-2">
                            <i class="fas fa-user-secret"></i> name: <strong>{{$ichancy->username}}</strong>
                            ...
                            @if($value)
                                <span class="text-danger"><i class="fas fa-money-bill-alt"></i> ichancy balance: {{$value}}</span>
                            @endif
                        </p>
                        <p class="mb-2"><i class="fas fa-lock"></i> pass: <strong>{{$ichancy->password}}</strong></p>
                        <p class="mb-0">
                    ...
                    <td class="d-none d-md-table-cell">
                        <p class="mb-0 mb-md-3 mt-1"><i class="far fa-user"></i> username: {{ $ichancy->chat->username}}</p>
                        <p class="mb-0 mb-md-3 mt-1"><i class="fas fa-user"></i> chat id: {{ $ichancy->chat_id }}
                    ...
                    <td class="d-none d-md-table-cell">
                        <div class="text-center mt-2">
                            <div>
                                <a href="{{ route('chats.createMessage', $ichancy->chat) }}" class="btn btn-primary"><i class="fab fa-telegram-plane"></i></a>
                ...
                <tr class="d-table-row d-md-none">
                    <td colspan="2">
                        <i class="far fa-user me-2"></i> <span class="fw-bold">username:</span> {{ $ichancy->chat->username}}<br>
                        <i class="far fa-user me-2"></i> <span class="fw-bold">chat id:</span> {{ $ichancy->chat_id}}<br>
                        <i class="far fa-calendar-alt me-2"></i> <span class="fw-bold">date:</span> {{$ichancy->created_at}}<br>
                ...
                <tr class="d-table-row d-md-none" >
                    <td colspan="2" class="text-center bg-body-tertiary ">
                        ...
                        <a href="{{ route('chats.createMessage', $ichancy->chat) }}" class="btn btn-primary btn-sm mx-3"><i class="fab fa-telegram-plane"></i></a>
